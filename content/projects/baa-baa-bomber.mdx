...
description: A prototype comedy game where sheep pilots bomb invading Nazi pigeons. Includes a physics-based main game, an infinite scroller variant, and experimental EEG controls.
date: 2024-01-15
...
Players step into the woolly boots of **Captain "Minty" Woolcock** of the Royal Sheep Air Force, tasked with bombing waves of invading Nazi pigeons. Each mission involves carefully timed bombing runs, bringing down pigeon fortresses with a mix of strategy, physics, and slapstick chaos.
