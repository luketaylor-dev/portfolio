...
I picked some generic action types that seemed useful across different games: `OpenShop`, `GiveItem`, `TriggerEvent`, etc. As development continues, I might add more actions or even support for multiple actions per choice. There’s also a custom action type for the occasional complex logic that might be needed.
...
💡 _Have you built your own dialogue tools in Unity? I’d love to hear about your approaches, challenges, and solutions. Feel free to reach out if you want to discuss Unity editor development or dialogue systems!_

_If you’re looking for someone who can design scalable Unity tools like this, let’s talk._
